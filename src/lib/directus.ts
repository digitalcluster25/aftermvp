...
const DIRECTUS_TOKEN = process.env.DIRECTUS_TOKEN || "3VrAInP_vNptID_m9dfGy7TfgNvMBgTB";
...
export async function getSpravochnikItem(id: number): Promise<SpravochnikItem | null> {
  try {
